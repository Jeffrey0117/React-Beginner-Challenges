...
export default function HomePage() {
  ...
  const handleManualUpdate = async () => {
    try {
      setUpdating(true)
      console.log('🔄 開始手動更新工作日報資料...')
      
      // 強制更新快取
      await fetch('/api/cache?forceUpdate=true')
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mb-2">載入中...</h2>
          <p className="text-gray-500">正在獲取工作日報統計資料</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-pink-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">載入失敗</h2>
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center items-center space-x-4 mb-6">
            <button
              ...
              disabled={updating}
              className="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-105"
            >
              {updating ? (
                <>
            ...
            >
              <div className="flex items-center justify-center">
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-600">瀏覽所有工作日報內容</p>
                </div>
              </div>
            </Link>
          </div>
